                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        infoRow(
                          title: "Machine name",
                          text: widget.dataAbnormal.mACHINE,
                        ),
                        infoRow(
                          title: "Location",
                          text: "${widget.dataAbnormal.lM}-${widget.dataAbnormal.sTATION}",
                        ),
                        infoRow(
                          title: "Part name",
                          text: "${widget.dataAbnormal.pARTNAME}-${widget.dataAbnormal.fEEDERSN}",
                        ),
                        infoRow(
                          title: "Total qty",
                          text: widget.dataAbnormal.tOTALQTY,
                        ),
                        infoRow(
                          title: "Fail qty",
                          text: "${widget.dataAbnormal.fAILQTY} (${widget.dataAbnormal.failRate}%)",
                          color: Colors.redAccent,
                        ),
                        infoRow(
                          title: "Time",
                          text: "${widget.dataAbnormal.dateT} ${widget.dataAbnormal.timeT}",
                        ),
                      ],
                    ),
                  ),
